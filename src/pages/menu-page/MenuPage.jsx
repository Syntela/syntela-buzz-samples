...
const Menu = () => {
  ...
  return (
    <div className="menu-container">
      <h1>Syntela Sample Apps</h1>
      <menu>
        <li>
          <MenuPageButton text="Tabbed Dashboard" path="/syntela-buzz-samples/tabbed-dashboard" />
          <p>
        ...
        <li>
          <MenuPageButton text="Chat Room List" path="/syntela-buzz-samples/chat-room-list" />
          <p>
        ...
        <li>
          <MenuPageButton text="Simple Meeting" path="/syntela-buzz-samples/simple-meeting" />
          <p>
        ...
        <li>
          <MenuPageButton text="Chat Room List UI" path="/syntela-buzz-samples/list-widget-ui" />
          <p>
        ...
        <li>
          <MenuPageButton text="Popout Chat" path="/syntela-buzz-samples/popout-chat" />
          <p>
        ...
        <li>
          <MenuPageButton text="Devices in Meeting" path="/syntela-buzz-samples/meeting-devices" />
          <p>
